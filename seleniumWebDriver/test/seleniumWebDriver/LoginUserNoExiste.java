...
public class LoginUserNoExiste {
  ...
  public void testLoginUserNoExiste() throws Exception {
    ...
    driver.findElement(By.id("Input_Email")).sendKeys("holac2019@ual.esss");
    ...
    assertEquals("Invalid login attempt.", driver.findElement(By.cssSelector("div.text-danger.validation-summary-errors > ul > li")).getText());
