...
public class RegistroPassDiferente {
  ...
  public void testRegistroPassDiferente() throws Exception {
    ...
    assertEquals("The password and confirmation password do not match.", driver.findElement(By.cssSelector("div.text-danger.validation-summary-errors > ul > li")).getText());
