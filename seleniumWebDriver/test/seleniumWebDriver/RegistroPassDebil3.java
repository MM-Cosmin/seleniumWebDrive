...
public class RegistroPassDebil3 {
  ...
  @Test
  public void testRegistroPassDebil3() throws Exception {
    ...
    driver.findElement(By.id("Input_Password")).sendKeys("ABabcd!!");
    driver.findElement(By.id("Input_ConfirmPassword")).clear();
    driver.findElement(By.id("Input_ConfirmPassword")).sendKeys("ABabcd!!");
    driver.findElement(By.xpath("//button[@type='submit']")).click();
    assertEquals("Passwords must have at least one digit ('0'-'9').", driver.findElement(By.cssSelector("div.text-danger.validation-summary-errors > ul > li")).getText());
