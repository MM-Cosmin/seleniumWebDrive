...
public class RegistroPassDebil2 {
  ...
  @Test
  public void testRegistroPassDebil2() throws Exception {
    ...
    assertEquals("Passwords must have at least one lowercase ('a'-'z').", driver.findElement(By.cssSelector("div.text-danger.validation-summary-errors > ul > li")).getText());
