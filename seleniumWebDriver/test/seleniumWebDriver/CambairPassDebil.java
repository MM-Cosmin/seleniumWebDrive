...
public class CambairPassDebil {
  ...
  @Test
  public void testCambairPassDebil() throws Exception {
    ...
    driver.findElement(By.id("Input_NewPassword")).sendKeys("ABab1234");
    driver.findElement(By.id("Input_ConfirmPassword")).clear();
    driver.findElement(By.id("Input_ConfirmPassword")).sendKeys("ABab1234");
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Password'])[1]/following::button[1]")).click();
    assertEquals("Passwords must have at least one non alphanumeric character.", driver.findElement(By.cssSelector("div.text-danger.validation-summary-errors > ul > li")).getText());
