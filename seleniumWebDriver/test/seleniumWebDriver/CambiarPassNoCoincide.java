...
public class CambiarPassNoCoincide {
  ...
  @Test
  public void testCambiarPassNoCoincide() throws Exception {
    ...
    driver.findElement(By.id("Input_NewPassword")).sendKeys("ABab12!!");
    driver.findElement(By.id("Input_ConfirmPassword")).clear();
    driver.findElement(By.id("Input_ConfirmPassword")).sendKeys("ABab12!");
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Password'])[1]/following::button[1]")).click();
    assertEquals("The new password and confirmation password do not match.", driver.findElement(By.cssSelector("div.text-danger.validation-summary-errors > ul > li")).getText());
