...
public class EditarPerfilEmailRequired {
  ...
  @Test
  public void testEditarPerfilEmailRequired() throws Exception {
    ...
    driver.get("http://loginapphmis2019jjcanada.azurewebsites.net/Account/Manage");
    driver.findElement(By.id("Input_Email")).clear();
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Password'])[1]/following::button[2]")).click();
    assertEquals("The Email field is required.", driver.findElement(By.cssSelector("div.text-danger.validation-summary-errors > ul > li")).getText());
