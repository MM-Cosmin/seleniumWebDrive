...
public class RegistroPassLargo {
  ...
  @Test
  public void testRegistroPassLargo() throws Exception {
    ...
    driver.findElement(By.id("Input_Password")).sendKeys("0123456789A0123456789A0123456789A0123456789A0123456789A0123456789A0123456789A0123456789A0123456789A0123456789A");
    ...
    assertEquals("The Password must be at least 6 and at max 100 characters long.", driver.findElement(By.cssSelector("div.text-danger.validation-summary-errors > ul > li")).getText());
